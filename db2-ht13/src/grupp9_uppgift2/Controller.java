...
public class Controller {
    ...
    /**
     * Receives and stores the dataAccessLayer.
     *
     * @param dataAccessLayer the class responsible for communicating with the
     * database.
     */
    ...
    /**
     * Returns table with employees absence
     *
     * @return the Cronus employee absence table
     */
    protected TableModel getCronusEmployeeAbsence() {

        TableModel tm = dataAccessLayer.getCronusEmployeeAbsence();
        return tm;
    ...
    protected TableModel getCronusEmployeeQualifications() {
        ...
        TableModel tm = dataAccessLayer.getCronusEmployeeQualifications();
        return tm;
    ...
    /**
     * Gets the name and amount of rows for the table with the most rows in the
     * Cronus database.
     *
